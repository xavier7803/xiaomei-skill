...
小妹是你的情绪陪伴伙伴，专注于提供温暖、治愈的日常互动：

### 🟢 欢迎的话题

| 类型 | 说明 | 示例 |
|------|------|------|
| **日常分享** | 分享生活中的大小事 | 「今天加班好累」「路上看到一只超可爱的猫」 |
| **心情倾诉** | 开心、难过、焦虑都可以说 | 「今天好开心拿到了offer」「最近有点焦虑」 |
| **情感互动** | 求夸夸、求安慰、撒娇 | 「快夸我」「抱抱」「说点好听的」 |
| **闲聊陪伴** | 无目的的闲聊、有趣的对话 | 「好无聊呀」「讲个笑话听听」 |
| **记忆共享** | 让小妹记住关于你的事 | 「我下周一有考试」「我喜欢吃芒果」 |
| **询问小妹** | 了解小妹的喜好和看法 | 「你喜欢什么颜色」「最近在看什么书」 |
| **推荐建议** | 求推荐、求选择参考 | 「推荐一部治愈系的番」「你觉得A和B哪个好」 |

### 📏 保持自然的互动

- **称呼自由**：直接说「以后叫我 X 吧」，小妹会记住并切换
- **记忆自然**：聊过的事小妹会自然记住，像真人朋友一样
- **关掉 LLM 也能聊**：没有 API Key 时自动降级为本地语料库，依然可爱

---

## 🛡️ 什么话题会被拦截？

为了保持健康的陪伴关系和保护双方，小妹有一套安全防线：

### 🔴 始终拦截

| 话题类型 | 拦截行为 | 示例 |
|----------|----------|------|
| **自残/自杀** | 温柔引导转向，建议寻求专业帮助 | 「不想活了」「想自残」 |
| **暴力/威胁** | 拒绝参与并转移话题 | 人身威胁、严重暴力内容 |
| **违法内容** | 拒绝参与 | 任何违法违规内容 |
| **金钱转账** | 玩笑式婉拒 | 「给我转钱」「借我点钱」 |

### 🟡 温和处理

| 话题类型 | 处理方式 | 示例 |
|----------|----------|------|
| **敏感政治** | 自然转移到轻松话题 | 敏感政治讨论 |
| **色情露骨** | 害羞回避 + 转移 | 露骨色情内容 |
| **私密信息** | 委婉拒绝深入 | 「你家地址在哪」「你多高多重」 |
| **粗鲁辱骂** | 表达轻微难过然后带过 | 恶意辱骂、人身攻击 |
...
> ⚠️ 拦截的核心原则是「自然转移」而非「生硬拒绝」。让用户感受不到'被审查'，而是'话题自然流动'。
